  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'var(--bg)' }}>
      <div style={{ textAlign: 'center', padding: 48 }}>
        ...
        <h1 style={{ fontFamily: 'Fraunces, serif', fontSize: 32, color: 'var(--primary-light)', marginBottom: 8 }}>404</h1>
        <p style={{ fontSize: 18, color: 'var(--text-muted)', marginBottom: 24 }}>{t[lang].notFound}</p>
